...
public class ThongTinSanPham_NhanVien extends javax.swing.JFrame {
    ...
    public ThongTinSanPham_NhanVien() {
        initComponents();
...
//    }
 ...
 public PreparedStatement createImage(Connection conn, String arg1, String arg2,byte[] imageBytes ) throws SQLException {// chen hinh vao dastabase
    ...
    private void jLabelHoadonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelHoadonMouseClicked
        // TODO add your handling code here:
           HoaDonNhanVien supf = new HoaDonNhanVien();
                ManipulateComponents xuli = new ManipulateComponents();
                supf.setIDNhanvien(idNhanvien);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThongTinSanPham_NhanVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThongTinSanPham_NhanVien().setVisible(true);
            }
        });
    }
