...
public class HoaDonNhanVien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel3);
        jLabel3.setBounds(31, 19, 180, 30);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jPanelEmployee, javax.swing.GroupLayout.DEFAULT_SIZE, 178, Short.MAX_VALUE)
                    .addComponent(jPanelCustomers, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addGap(0, 0, Short.MAX_VALUE))
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jPanelPhanCong, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
    ...
    private void jPanelEmployeeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelEmployeeMouseClicked
        // TODO add your handling code here:
        ThongTinNhanvien supf = new ThongTinNhanvien();
        ManipulateComponents xuli = new ManipulateComponents();
        supf.setIDNhanvien(idNhanvien);
    ...
    private void jPanelProductsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelProductsMouseClicked
        ...
        ThongTinSanPham_NhanVien supf = new ThongTinSanPham_NhanVien();
        ManipulateComponents xuli = new ManipulateComponents();
        supf.setIdNhanvien(idNhanvien);
    ...
    private void jPanelPhanCongMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelPhanCongMouseClicked
        ...
        PhanCongNhanVien supf = new PhanCongNhanVien();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HoaDonNhanVien().setVisible(true);
            }
        });
    }
