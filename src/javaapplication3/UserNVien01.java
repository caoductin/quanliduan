...
public class UserNVien01 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ngày làm", "Ca làm", "Doanh thu sản phẩm đã bán (xem chi tiết)", "Trạng thái"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserNVien01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserNVien01().setVisible(true);
            }
        });
    }
